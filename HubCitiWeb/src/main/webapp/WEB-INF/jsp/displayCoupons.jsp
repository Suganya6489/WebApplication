...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if($(".hdrClone span").length) {
			$(".hdrClone").find("span:gt(0)").css("text-indent","8px");
		} else {
			$(".hdrClone").find("span:gt(0)").css("text-indent","0px");
		}		
	});
</script>
<script type="text/javascript">
		...
		<div class="content" id="">
			...
			<div class="cont-pnl split" id="equalHt">
				<div class="cont-block rt-brdr stretch">
					...
					<div class="tabd-pnl">
						<ul class="nav-tabs">
							<li><a class="active" href="#">Coupon</a></li>
							<li><a class="" href="javascript:void(0);"
								onclick="displayDeals();">Hot Deal</a></li>
					...
					<div class="cont-wrp">
						<form:form name="deals" id="deals" commandName="deals">
							<form:hidden path="dealId" id="dealId" />
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<tr>
									...
									<td width="10%"><a href="#"><img
											...
											alt="search" title="search coupons" onclick="searchDeals()"/></a></td>
